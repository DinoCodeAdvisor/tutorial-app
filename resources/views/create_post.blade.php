            ...
            <main class="flex gap-10 justify-between w-full px-20 py-10 flex-col lg:flex-row">
                <div class="text-[13px] leading-[20px] flex-1 p-6 pb-12 lg:p-20 bg-white dark:bg-[#161615] dark:text-[#EDEDEC] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d] rounded-bl-lg rounded-br-lg lg:rounded-tl-lg lg:rounded-br-none ">
                    ...
                    <div class="flex flex-col gap-5 justify-start mb-10">
                            <h1 class="flex font-bold text-2xl">Make your own Post</h1>
                            <form action="{{route('posts.store')}}" method="POST">
                                ...
                                <div class="mb-5">
                                    ...
                                    placeholder="Lorem Ipsum" value="{{old('title')}}" required />
                                    @error('title')
                                ...
                                <div class="mb-5">
                                    ...
                                    <textarea type="text" name="content" id="content" maxlength="250" value="{{old('content')}}"
                                    ...
                                    placeholder="Lorem ipsum, dolor sit amet consectetur adipisicing elit. Magnam fugit odio quae eius, cumque veniam enim exercitationem mollitia sequi, voluptatem minus commodi obcaecati deserunt dicta unde provident ab labore placeat." required></textarea>
